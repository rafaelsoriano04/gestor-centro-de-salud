...
public class FrmModificarConsulta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtantece, new org.netbeans.lib.awtextra.AbsoluteConstraints(609, 57, 300, 135));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 585, -1, -1));
        ...
        getContentPane().add(txttipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(201, 281, 208, -1));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 620, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (cbconsulta.getItemCount() == 0) {
            JOptionPane.showMessageDialog(null, "El paciente no tiene consultas para modificar");
            this.dispose();
        } else {
            Consulta pac = (Consulta) cbconsulta.getSelectedItem();
            pac.tipo = txttipo.getText();
            pac.diagnostico = txtdiagnostico.getText();
            pac.observacion = txtobservaciones.getText();
            pac.signos = txtsintomas.getText();
            pac.tratamiento = txttratamiento.getText();
            if (new MetodosSQL().modificarConsulta(pac)) {
                JOptionPane.showMessageDialog(null, "La consulta se modifico Correctamente");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmModificarConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmModificarConsulta(0, null).setVisible(true);
            }
        });
    }
